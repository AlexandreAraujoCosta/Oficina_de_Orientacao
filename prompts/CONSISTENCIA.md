...
Chamou-se **Alberto** até 03/09/2026, quando o nome passou ao gerador rápido
(`ALBERTO.md`). O conteúdo é o mesmo, e a ferramenta continua servindo ao caso em
que só se quer dobrar o trabalho sobre si mesmo, sem julgar o argumento.
