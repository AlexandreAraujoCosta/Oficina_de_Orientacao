...
**O veredicto.** Em trabalho que vai a banca, quatro degraus: pronto para ir à banca; pronto depois de ajustes delimitados; tem pontos que precisam ser desenvolvidos; em estágio inicial. Em artigo ou capítulo que vai a revista, o veredicto é sobre **o momento de submeter**, e não sobre o mérito de publicar. **Nunca escreva "recomendação: aprovar" nem que o texto merece publicação:** aprovar é ato da banca, publicar é decisão do editor.
